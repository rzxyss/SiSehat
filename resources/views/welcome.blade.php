...
@section('home')
    <section
        class="bg-center bg-cover bg-no-repeat bg-[url('http://127.0.0.1:8000/assets/image/hero.jpg')] bg-gray-600 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 font-montserrat">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="#"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary hover:bg-shade1 focus:outline-none">
                    Get started
